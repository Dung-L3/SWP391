...
public class MenuManagementServlet extends HttpServlet {
    ...
    private boolean hasMenuManagementPermission(User user) {
        // Only Manager can create, edit, delete menu items
        return "Manager".equals(user.getRoleName());
    }

    /**
     * Check if user can view menu (all authenticated users can view)
     */
    private boolean hasMenuViewPermission(User user) {
