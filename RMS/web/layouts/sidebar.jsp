...
<aside class="sidebar">
    ...
    <div class="brand d-flex align-items-center justify-content-between">
        ...
        <button class="btn btn-sm btn-outline-light d-lg-none" onclick="if (window.toggleSidebar) {
                toggleSidebar();
    ...
    <ul class="menu">
        ...
        <li>
            <a class="${page == 'reception-walkin' ? 'active' : ''}"
               href="<c:url value='/reception/walkin-booking'/>">
                <i class="bi bi-person-lines-fill"></i>Nhận đặt bàn (quầy)
            </a>
        </li>
        <li>
            <a class="${page == 'reception-transfer' ? 'active' : ''}"
               href="<c:url value='/reception/transfer-table'/>">
                <i class="bi bi-arrow-left-right"></i>Chuyển bàn
            </a>
        </li>

        <li>
            <a class="${page == 'reception-checkin' ? 'active' : ''}" 
               href="<c:url value='/reception/checkin-table'/>">
