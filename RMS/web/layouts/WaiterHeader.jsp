...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container-fluid">
        <a class="navbar-brand" href="${pageContext.request.contextPath}/tables">
            <i class="fas fa-utensils"></i> RMS - <c:choose><c:when test="${user != null}">${user.firstName} ${user.lastName}</c:when><c:otherwise>Waiter</c:otherwise></c:choose>
        </a>
            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link" href="${pageContext.request.contextPath}/tables">
                        <i class="fas fa-map"></i> Sơ đồ bàn
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="${pageContext.request.contextPath}/order-page">
