...
<head>
    <meta charset="utf-8">
    <title>Home | Restoran</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Restoran – Delicious meals & great service">
    ...
    <div class="container">
        ...
        <div class="row g-4">
            <c:forEach var="i" begin="1" end="4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="${i*0.2-0.1}s">
                    <div class="team-item text-center rounded overflow-hidden">
                        <div class="rounded-circle overflow-hidden m-4">
                            <img class="img-fluid" src="<c:url value='/img/team-${i}.jpg'/>" alt="Chef ${i}">
                        </div>
        ...
        <div class="owl-carousel testimonial-carousel">
            <c:forEach var="i" begin="1" end="4">
                <div class="testimonial-item bg-transparent border rounded p-4">
                    ...
                    <div class="d-flex align-items-center">
                        <img class="img-fluid flex-shrink-0 rounded-circle" src="<c:url value='/img/testimonial-${i}.jpg'/>" style="width:50px;height:50px;" alt="Client ${i}">
                        <div class="ps-3">
