                                                        ...
                                                        <td>
                                                            <c:choose>
                                                                ...
                                                                <c:when test="${r.dayOfWeek == 1}">
                                                                    <span class="badge bg-info text-dark" style="font-size:.7rem;">Thứ 2</span>
                                                                </c:when>
                                                                <c:when test="${r.dayOfWeek == 2}">
                                                                    <span class="badge bg-info text-dark" style="font-size:.7rem;">Thứ 3</span>
                                                                </c:when>
                                                                <c:when test="${r.dayOfWeek == 3}">
                                                                    <span class="badge bg-info text-dark" style="font-size:.7rem;">Thứ 4</span>
                                                                </c:when>
                                                                <c:when test="${r.dayOfWeek == 4}">
                                                                    <span class="badge bg-info text-dark" style="font-size:.7rem;">Thứ 5</span>
                                                                </c:when>
                                                                <c:when test="${r.dayOfWeek == 5}">
                                                                    <span class="badge bg-info text-dark" style="font-size:.7rem;">Thứ 6</span>
                                                                </c:when>
                                                                <c:when test="${r.dayOfWeek == 6}">
                                                                    <span class="badge bg-info text-dark" style="font-size:.7rem;">Thứ 7</span>
                                                                </c:when>
                                                                <c:when test="${r.dayOfWeek == 7}">
                                                                    <span class="badge bg-info text-dark" style="font-size:.7rem;">Chủ nhật</span>
                                                                </c:when>
                                                                <c:otherwise>
