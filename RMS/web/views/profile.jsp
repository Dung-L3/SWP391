    ...
    <head>
        ...
        <style>
            ...
            .profile-card{
                ...
                box-shadow:0 12px 30px rgba(20,24,40,.08)
            }
            .avatar-wrap{
                position:relative;
    ...
    <body>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                ...
                <c:if test="${not empty sessionScope.profileMsgSuccess}">
                    <div class="alert alert-success d-flex align-items-start">
                        <i class="bi bi-check-circle me-2"></i>
                        <div>${sessionScope.profileMsgSuccess}</div>
                    </div>
                    <c:remove var="profileMsgSuccess" scope="session"/>
                </c:if>

                <c:if test="${not empty sessionScope.profileMsgError}">
                    <div class="alert alert-danger d-flex align-items-start">
                        <i class="bi bi-exclamation-triangle me-2"></i>
                        <div>${sessionScope.profileMsgError}</div>
                    </div>
                    <c:remove var="profileMsgError" scope="session"/>
                </c:if>
                ...
                <div class="card profile-card lift-up">
                    <div class="card-body p-4 p-lg-5">
                        <!-- Profile form -->
                        <form id="profileForm"
                              action="<c:url value='/UpdateProfileServlet'/>"
                              method="post"
                              enctype="multipart/form-data"
                              class="row g-4"
                              novalidate>

                            <!-- Left: Avatar + role + status -->
                            <div class="col-lg-4 text-center">
                                <div class="avatar-wrap mb-3">
                                    <img id="avatarPreview"
                                         src="<c:url value='${empty u.avatarUrl ? "/img/team-1.jpg" : u.avatarUrl}'/>"
                                         class="rounded-circle"
                                         style="width:140px;height:140px;object-fit:cover;border:4px solid rgba(0,0,0,.05)"
                                         alt="avatar">
                                ...
                                <div class="mb-2">
                                    ...
                                    <span class="badge bg-primary">
                                        <c:out value="${empty u.roleName ? '—' : u.roleName}"/>
                                    </span>
                                </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div id="emailHelp" class="form-text">
                                            Chỉ chấp nhận địa chỉ <strong>@gmail.com</strong>, không có khoảng trắng.
                                        </div>
                                        <div class="invalid-feedback">
                                            Email không hợp lệ. Vui lòng dùng định dạng <em>username@gmail.com</em>.
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div id="phoneHelp" class="form-text">
                                            Phải gồm <strong>10 số</strong>, bắt đầu bằng <strong>0</strong>, không có khoảng trắng.
                                        </div>
                                        <div class="invalid-feedback">
                                            Số điện thoại không hợp lệ. Ví dụ hợp lệ: 0901234567.
                                        </div>
                                    </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password"
                                       ...
                                       required
                                       minlength="6">
                                <div class="form-text">Ít nhất 6 ký tự, nên có cả chữ và số.</div>
                            </div>
                            <div class="mb-3">
        ...
        <script>
            (function () {
                ...
                [email, phone].forEach(el => el && el.addEventListener('keydown', e => {
                        if (e.key === ' ')
                            e.preventDefault();
                    }));
            ...
            // Simple confirm check in modal
            (function () {
                const newPass = document.getElementById('newPassword');
                const confirmPass = document.getElementById('confirmPassword');
                const modalForm = document.querySelector('#changePassModal form');
